...
Для перемещения между ветками используем команду:
  ...
  При слиянии веток существует вероятность создания ситуации конфликта, когда строка в разных версиях веток пишется по-разному.

  *Git* может автоматически сохранить эти изменения, но нам придется вручную откорректировать разные варианты.

  *VScode* предлагает 3 варианта устранения конфликта : сохранить первый вариант, выбрать другой или сохранить оба этих варианта вместе.
